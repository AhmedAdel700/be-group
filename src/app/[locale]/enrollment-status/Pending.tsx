  ...
  const otherApplications: DiplomaApplication[] = [
    {
      ...
      status: "rejected",
      rejectionReason: t("Insufficient mathematics background", {
        default: "Insufficient mathematics background",
      }),
