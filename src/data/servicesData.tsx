...
export const servicesData: Service[] = [
  {
    ...
    description: "Embark on a journey of creativity and excellence with Be Group's Animation Video service. We turn ideas into mesmerizing visuals that captivate minds and hearts—perfect for explainers, product demos, or unforgettable brand stories.",
    features: [
  ...
  },
  {
    ...
    description: "We plan, create, and manage content that grows communities and drives results—tailored for each platform's culture and algorithm.",
    features: [
  ...
  },
  {
    ...
    description: "Since 2009, Be Group has delivered high-impact web and e-commerce solutions across MENA. We use modern stacks and Agile/Scrum to ship robust, maintainable products—on time.",
    features: [
  ...
  },
  {
    ...
    slug: "google-ads",
    description: "Be Group is a 2023 Google Premier Partner with certified strategists, strong optimization scores, and proven spend management. We build data-driven campaigns that scale.",
    features: [
  ...
  },
  {
    ...
    slug: "seo",
    description: "Full-stack SEO: technical audits, on-page optimization, content strategy, and high-quality link building. We pair research with clean IA and UX to grow qualified traffic sustainably.",
    features: [
  ...
  },
  {
    ...
    slug: "google-maps",
    description: "Optimize your Business Profile to win local intent across Search and Maps. We manage photos, posts, offers, reviews, and messaging to convert discovery into visits and calls.",
    features: [
  ...
  },
  {
    ...
    description: "End-to-end production: scripting, directing, shooting, editing, motion graphics, VFX, and sound design. We deliver broadcast-grade results tailored to your brand voice.",
    features: [
      "Video production",
      "Motion graphics",
      "Sound design",
  ...
  },
  {
    ...
    slug: "branding",
    description: "Research-backed visual identities—logos, palettes, typography, guidelines, and assets—that align with your positioning and scale across print and digital touchpoints.",
    features: [
      "Logo design",
      "Brand identity",
      "Typography design",
  ...
  },
  {
    ...
    slug: "consultation",
    description: "Marketing and product consulting: market analysis, opportunity mapping, brand development, CX/CRM improvements, and measurable go-to-market plans.",
    features: [
      "Market analysis",
      "Strategy planning",
      "Brand development",
