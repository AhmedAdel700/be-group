        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              ...
              والعمليات داخل محطات الوقود من طلبيات شراء واستلام الوقود، مروراً
              بتزويد الخزانات بالوقود ثم بيعه من خلال المضخات وإصدار الفواتير
              وإغلاق الورديات في وقت وجيز، ومن ثم تقليل نسب الأخطاء البشرية و
              خفض التكاليف وتحقيق الرقابة الداخلية.
            </p>
            <p className="text-lg text-gray-700 mb-6 leading-relaxed">
              يوفر (جازتك GasTech) حلولاً تحقق الترابط الكامل والمباشر بين أجهزة
              المحطات والأنظمة والتطبيقات والمركز الرئيسي، مما يسهم ذلك وبشكل
              لحظي في قراءة معلومات المضخات ومراقبة خزانات الوقود وتغيير
