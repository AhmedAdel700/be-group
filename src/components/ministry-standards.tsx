      ...
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <p className="text-lg text-gray-700 mb-6 leading-relaxed">
            يمتاز نظام جازتك GasTech بتوافقه لمعايير واشتراطات وزارة الطاقة
            لتأهيل محطات الوقود تقنياً، والمتعلقة بالربط المركزي - قراءات
            المضخات - تغيير أسعار الوقود - مراقبة الخزانات - النقليات - مبيعات
            التجزئة - إدارة المدفوعات - إدارة الصيانة والأعطال - ولاء العملاء -
            تطبيقات الجوال - الخدمة الذاتية - الفواتير الإلكترونية – الموارد
            البشرية – أنظمة تخطيط الموارد ...الخ
          </p>
